...
export function Layout() {
  ...
  return (
    <div className="ff-app-shell min-h-screen pb-24 md:pb-0">
      <header className="sticky top-0 z-40 border-b border-white/10 bg-[#090909]/95 px-4 py-3 backdrop-blur md:hidden">
        <div className="mx-auto flex max-w-6xl items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="text-[10px] uppercase tracking-[0.18em] text-white/55">FashionFit</div>
              <div className="text-sm font-semibold text-white">Client Studio</div>
            </div>
          </div>
          <button onClick={handleLogout} className="ff-btn-secondary border-white/20 bg-white/10 px-3 py-2 text-xs text-white">
      ...
      <div className="mx-auto flex w-full max-w-[1400px] gap-5 px-4 py-5 sm:px-6 lg:px-8 lg:py-8">
        <aside className="hidden w-[290px] shrink-0 flex-col rounded-[28px] border border-white/10 bg-[#0a0a0a] p-5 text-white shadow-[0_30px_80px_-40px_rgba(0,0,0,0.8)] md:flex">
          <div className="rounded-2xl border border-white/15 bg-white/5 p-4">
            <div className="flex items-center gap-3">
              <span className="flex h-11 w-11 items-center justify-center rounded-full border border-white/15 bg-white/10 text-white">
                <Shirt size={20} />
              </span>
              <div>
          ...
          <div className="mt-auto rounded-2xl border border-white/15 bg-white/5 p-4">
            ...
            <button onClick={handleLogout} className="ff-btn-secondary w-full justify-start border-white/20 bg-white/10 text-white">
              <LogOut size={16} />
              Wyloguj
            </button>
          </div>
      ...
      <nav className="fixed inset-x-3 bottom-3 z-40 rounded-2xl border border-white/12 bg-[#080808]/95 p-2 shadow-2xl backdrop-blur md:hidden">
