...
`;function H(r){if(document.getElementById("ff-styles"))return;document.documentElement.style.setProperty("--ff-primary",r);let o=document.createElement("style");o.id="ff-styles",o.textContent=et,document.head.appendChild(o)}function K(r){let o={"X-API-Key":r.apiKey,"Content-Type":"application/json"};async function n(e,a={}){let s=await fetch(r.apiUrl+e,{headers:o,...a}),u=await s.json().catch(()=>({}));if(!s.ok)throw new Error(u.error||`\u017B\u0105danie nie powiod\u0142o si\u0119 (${s.status})`);return u}return{getProducts(){return n(`/api/widget/products/${r.shopId}`)},startPhotoTryon(e,a,s){return n("/api/widget/tryon/photo",{method:"POST",body:JSON.stringify({shopId:r.shopId,productId:e,personImageBase64:a,preferredProvider:r.tryonProvider||"auto",metadata:{...s||{},preferredProvider:r.tryonProvider||"auto"}})})},getTryonStatus(e){return n(`/api/widget/tryon/status/${e}`)},trackEvent(e,a={}){return n("/api/widget/events",{method:"POST",body:JSON.stringify({shopId:r.shopId,eventType:e,...a})}).catch(()=>{})}}}var ot="0.10.14",X=`https://cdn.jsdelivr.net/npm/@mediapipe/tasks-vision@${ot}`,rt=`${X}/wasm`,nt="https://storage.googleapis.com/mediapipe-models/pose_landmarker/pose_landmarker_lite/float16/1/pose_landmarker_lite.task",F;function at(){return F||(F=new Function("u","return import(u)")(X)),F}async function G({video:r,canvas:o,garmentUrl:n}){let e=o.getContext("2d"),a=null,s=null,u=null,f=!1,h=1,l=new Image;l.crossOrigin="anonymous",n&&(l.src=n);let x=await at(),C=await x.FilesetResolver.forVisionTasks(rt);s=await x.PoseLandmarker.createFromOptions(C,{baseOptions:{modelAssetPath:nt,delegate:"GPU"},runningMode:"VIDEO",numPoses:1}),a=await navigator.mediaDevices.getUserMedia({video:{facingMode:"user"},audio:!1}),r.srcObject=a,await r.play(),o.width=r.videoWidth||640,o.height=r.videoHeight||480,f=!0,E();function E(){if(f){if(e.drawImage(r,0,0,o.width,o.height),s&&r.readyState>=2)try{let p=s.detectForVideo(r,performance.now()),g=p.landmarks&&p.landmarks[0];g&&T(g)}catch{}u=requestAnimationFrame(E)}}function T(p){if(!l.complete||!l.naturalWidth)return;let g=p[12],S=p[11];if(!g||!S)return;let w=o.width,z=o.height,j=g.x*w,A=g.y*z,P=S.x*w,I=S.y*z,L=Math.hypot(P-j,I-A)*1.8*h,U=l.naturalHeight/l.naturalWidth,i=L*U,c=(j+P)/2,d=(A+I)/2-i*.15;e.save(),e.globalAlpha=.92,e.drawImage(l,c-L/2,d,L,i),e.restore()}function k(){if(f=!1,u&&cancelAnimationFrame(u),a&&a.getTracks().forEach(p=>p.stop()),s&&s.close)try{s.close()}catch{}}return{setScale(p){h=p},capture(){return o.toDataURL("image/jpeg",.92)},stop:k}}var it=["XS","S","M","L","XL","XXL"],st=3e3,ct=20;function V({config:r,api:o,product:n,externalId:e}){let a=_(),s=n.name||a.name,u=n.garment_image_url||a.image,f=null,h=null,l=null,x="M",C=t("button",{class:"ff-fab",type:"button","aria-label":"FashionFit",onclick:T},r.buttonLabel);function E(){document.body.appendChild(C)}function T(){f&&f.remove(),h=t("div",{class:"ff-modal-body"}),f=t("div",{class:"ff-overlay",onclick:i=>{i.target===f&&k()}},t("div",{class:"ff-modal"},t("button",{class:"ff-close",type:"button","aria-label":"Zamknij",onclick:k},"\xD7"),h)),document.body.appendChild(f),requestAnimationFrame(()=>f.classList.add("ff-open")),w(),o.trackEvent("widget_open",{productId:n.id})}function k(){if(o.trackEvent("close",{productId:n.id}),p(),f){let i=f;i.classList.remove("ff-open"),setTimeout(()=>i.remove(),200),f=null}}function p(){l&&(l.stop(),l=null)}function g(...i){h.innerHTML="",i.forEach(c=>h.appendChild(c))}function S(){return t("div",{class:"ff-product"},u?t("img",{src:u,alt:s}):null,t("b",{},s))}function w(){p();let i=t("div",{class:"ff-sizes"},...it.map(c=>{let d=t("button",{class:`ff-size${c===x?" ff-active":""}`,type:"button",onclick:()=>{x=c,i.querySelectorAll(".ff-size").forEach(y=>y.classList.remove("ff-active")),d.classList.add("ff-active")}},c);return d}));g(t("h2",{class:"ff-h"},"Wirtualna przymierzalnia"),S(),t("div",{class:"ff-modes"},t("button",{class:"ff-mode",type:"button",onclick:z},t("span",{class:"ff-emoji"},"\u{1F4F8}"),t("span",{class:"ff-mode-label"},"Wgraj zdj\u0119cie")),t("button",{class:"ff-mode",type:"button",onclick:M},t("span",{class:"ff-badge"},"Nowe"),t("span",{class:"ff-emoji"},"\u{1F4F9}"),t("span",{class:"ff-mode-label"},"U\u017Cyj kamerki"))),t("div",{class:"ff-sub"},"Wybierz rozmiar"),i,t("div",{class:"ff-privacy"},"\u{1F512} Twoje zdj\u0119cia nie s\u0105 zapisywane"))}function z(){let i=null,c=t("input",{type:"file",accept:"image/jpeg,image/png",style:{display:"none"}}),d=t("div",{class:"ff-error",style:{display:"none"}}),y=t("button",{class:"ff-btn",type:"button",disabled:"true",onclick:()=>Z()},"Przymierz"),v=t("div",{}),b=t("div",{class:"ff-drop"},t("span",{class:"ff-emoji"},"\u2B06\uFE0F"),t("span",{},"Przeci\u0105gnij zdj\u0119cie lub kliknij, aby wgra\u0107"),t("span",{class:"ff-sub"},"JPG lub PNG, maks. 10MB"));function R(m){d.textContent=m,d.style.display=m?"block":"none"}async function W(m){let O=q(m);if(O){R(O);return}R(""),i=await B(m),v.innerHTML="",v.appendChild(t("img",{class:"ff-preview",src:i,alt:"Podgl\u0105d"})),y.removeAttribute("disabled")}b.addEventListener("click",()=>c.click()),b.addEventListener("dragover",m=>{m.preventDefault(),b.classList.add("ff-over")}),b.addEventListener("dragleave",()=>b.classList.remove("ff-over")),b.addEventListener("drop",m=>{m.preventDefault(),b.classList.remove("ff-over"),m.dataTransfer.files[0]&&W(m.dataTransfer.files[0])}),c.addEventListener("change",()=>{c.files[0]&&W(c.files[0])});async function Z(){if(i){o.trackEvent("tryon_start",{productId:n.id,metadata:{mode:"photo",size:x}}),j();try{let{sessionId:m}=await o.startPhotoTryon(n.id,i,{size:x});A(m)}catch(m){P(m.message)}}}g(t("h2",{class:"ff-h"},"\u{1F4F8} Wgraj swoje zdj\u0119cie"),b,c,v,d,t("div",{class:"ff-actions"},y,t("button",{class:"ff-btn ff-btn-ghost",type:"button",onclick:w},"\u2190 Wr\xF3\u0107")))}function j(){let i=t("span",{});g(t("div",{class:"ff-loading"},t("div",{class:"ff-spinner"}),t("b",{},"Generuj\u0119 dla Ciebie..."),t("div",{class:"ff-sub"},"To potrwa oko\u0142o 10 sekund"),t("div",{class:"ff-progress"},i)));let c=5,d=setInterval(()=>{c=Math.min(90,c+6),i.style.width=`${c}%`,f||clearInterval(d)},700);return()=>{clearInterval(d),i.style.width="100%"}}function A(i){let c=0,d=j(),y=setInterval(async()=>{if(c+=1,!f){clearInterval(y);return}try{let{status:v,resultImageUrl:b}=await o.getTryonStatus(i);v==="completed"&&b?(clearInterval(y),d(),I(b)):(v==="failed"||c>=ct)&&(clearInterval(y),P("Nie uda\u0142o si\u0119 wygenerowa\u0107 przymiarki. Spr\xF3buj ponownie."))}catch(v){clearInterval(y),P(v.message)}},st)}function P(i){g(t("h2",{class:"ff-h"},"Co\u015B posz\u0142o nie tak"),t("div",{class:"ff-error"},i),t("div",{class:"ff-actions"},t("button",{class:"ff-btn",type:"button",onclick:z},"Spr\xF3buj ponownie"),t("button",{class:"ff-btn ff-btn-ghost",type:"button",onclick:w},"\u2190 Wr\xF3\u0107")))}function I(i){o.trackEvent("tryon_complete",{productId:n.id,metadata:{size:x}}),g(t("h2",{class:"ff-h"},"Twoja przymiarka \u2728"),t("img",{class:"ff-result",src:i,alt:"Wynik przymiarki"}),t("div",{class:"ff-actions"},t("button",{class:"ff-btn",type:"button",onclick:U},"\u{1F6D2} Dodaj do koszyka"),t("button",{class:"ff-btn ff-btn-ghost",type:"button",onclick:()=>{o.trackEvent("download",{productId:n.id}),Y(i,"fashionfit.jpg")}},"\u2B07\uFE0F Pobierz zdj\u0119cie"),t("button",{class:"ff-btn ff-btn-ghost",type:"button",onclick:w},"\u{1F501} Przymierz inne")))}async function M(){let i=t("video",{class:"ff-video",playsinline:"true",muted:"true"}),c=t("canvas",{class:"ff-canvas"}),d=t("input",{class:"ff-slider",type:"range",min:"0.6",max:"1.6",step:"0.05",value:"1"}),y=t("div",{class:"ff-sub"},"Uruchamiam kamer\u0119...");d.addEventListener("input",()=>{l&&l.setScale(parseFloat(d.value))}),g(t("h2",{class:"ff-h"},"\u{1F4F9} Przymierzalnia na \u017Cywo"),y,i,c,t("label",{class:"ff-sub"},"Dopasuj rozmiar"),d,t("div",{class:"ff-actions"},t("button",{class:"ff-btn",type:"button",onclick:v},"\u{1F4F8} Zr\xF3b zdj\u0119cie"),t("button",{class:"ff-btn ff-btn-ghost",type:"button",onclick:w},"\u2190 Wr\xF3\u0107"))),o.trackEvent("tryon_start",{productId:n.id,metadata:{mode:"ar",size:x}});try{l=await G({video:i,canvas:c,garmentUrl:n.garment_image_url}),y.textContent="Sta\u0144 w kadrze ca\u0142\u0105 sylwetk\u0105"}catch{L()}function v(){if(!l)return;let b=l.capture();p(),I(b)}}function L(){p(),g(t("h2",{class:"ff-h"},"Kamera niedost\u0119pna"),t("div",{class:"ff-sub"},"Nie uda\u0142o si\u0119 uzyska\u0107 dost\u0119pu do kamery. Skorzystaj z trybu zdj\u0119cia."),t("div",{class:"ff-actions"},t("button",{class:"ff-btn",type:"button",onclick:z},"\u{1F4F8} U\u017Cyj trybu zdj\u0119cia"),t("button",{class:"ff-btn ff-btn-ghost",type:"button",onclick:w},"\u2190 Wr\xF3\u0107")))}async function U(){if(o.trackEvent("add_to_cart",{productId:n.id,metadata:{size:x}}),!e){n.product_url&&(window.location=n.product_url);return}try{let i=new FormData;i.append("product_id",e),i.append("quantity","1"),await fetch(`${location.origin}/?wc-ajax=add_to_cart`,{method:"POST",body:i}),document.body.dispatchEvent(new Event("wc_fragment_refresh")),k()}catch{window.location=`${location.pathname}?add-to-cart=${e}`}}return{mount:E,open:T,close:k}}var ft=document.currentScript;async function J(){let r=N(ft);if(!r.apiKey||!r.shopId){console.warn("[FashionFit] Brak apiKey lub shopId \u2014 widget nie zosta\u0142 uruchomiony.");return}if(!D())return;let o=$();H(r.primaryColor);let n=K(r),e=null;if(o)try{let{products:a}=await n.getProducts(),s=a||[];if(e=s.find(u=>String(u.external_id)===String(o))||null,!e){let u=location.pathname.replace(/\/+$/,"");e=s.find(f=>{if(!f.product_url)return!1;try{return new URL(f.product_url).pathname.replace(/\/+$/,"")===u}catch{return!1}})||null}if(!e){let u=_(),f=h=>String(h||"").trim().toLowerCase();e=s.find(h=>f(h.name)===f(u.name))||null}}catch(a){console.warn("[FashionFit] Nie uda\u0142o si\u0119 pobra\u0107 produkt\xF3w:",a.message)}if(!e){let a=_();e={id:o||`fallback:${location.pathname}`,external_id:o||null,name:a.name||"Produkt",garment_image_url:a.image||null,product_url:location.href,category:"tops",variants:null,_fallback:!0},console.warn("[FashionFit] Nie znaleziono zsynchronizowanego produktu dla id, uruchamiam fallback:",o)}V({config:r,api:n,product:e,externalId:o}).mount()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",J):J();})();
