...
`;function K(r){if(document.getElementById("ff-styles"))return;document.documentElement.style.setProperty("--ff-primary",r);let o=document.createElement("style");o.id="ff-styles",o.textContent=et,document.head.appendChild(o)}function X(r){let o={"X-API-Key":r.apiKey,"Content-Type":"application/json"};async function n(e,a={}){let s=await fetch(r.apiUrl+e,{headers:o,...a}),u=await s.json().catch(()=>({}));if(!s.ok)throw new Error(u.error||`\u017B\u0105danie nie powiod\u0142o si\u0119 (${s.status})`);return u}return{getProducts(){return n(`/api/widget/products/${r.shopId}`)},startPhotoTryon(e,a,s){return n("/api/widget/tryon/photo",{method:"POST",body:JSON.stringify({shopId:r.shopId,productId:e,personImageBase64:a,metadata:s})})},getTryonStatus(e){return n(`/api/widget/tryon/status/${e}`)},trackEvent(e,a={}){return n("/api/widget/events",{method:"POST",body:JSON.stringify({shopId:r.shopId,eventType:e,...a})}).catch(()=>{})}}}var ot="0.10.14",Y=`https://cdn.jsdelivr.net/npm/@mediapipe/tasks-vision@${ot}`,rt=`${Y}/wasm`,nt="https://storage.googleapis.com/mediapipe-models/pose_landmarker/pose_landmarker_lite/float16/1/pose_landmarker_lite.task",M;function at(){return M||(M=new Function("u","return import(u)")(Y)),M}async function G({video:r,canvas:o,garmentUrl:n}){let e=o.getContext("2d"),a=null,s=null,u=null,f=!1,y=1,l=new Image;l.crossOrigin="anonymous",n&&(l.src=n);let x=await at(),C=await x.FilesetResolver.forVisionTasks(rt);s=await x.PoseLandmarker.createFromOptions(C,{baseOptions:{modelAssetPath:nt,delegate:"GPU"},runningMode:"VIDEO",numPoses:1}),a=await navigator.mediaDevices.getUserMedia({video:{facingMode:"user"},audio:!1}),r.srcObject=a,await r.play(),o.width=r.videoWidth||640,o.height=r.videoHeight||480,f=!0,E();function E(){if(f){if(e.drawImage(r,0,0,o.width,o.height),s&&r.readyState>=2)try{let p=s.detectForVideo(r,performance.now()),b=p.landmarks&&p.landmarks[0];b&&_(b)}catch{}u=requestAnimationFrame(E)}}function _(p){if(!l.complete||!l.naturalWidth)return;let b=p[12],I=p[11];if(!b||!I)return;let w=o.width,z=o.height,j=b.x*w,T=b.y*z,S=I.x*w,L=I.y*z,P=Math.hypot(S-j,L-T)*1.8*y,F=l.naturalHeight/l.naturalWidth,i=P*F,c=(j+S)/2,d=(T+L)/2-i*.15;e.save(),e.globalAlpha=.92,e.drawImage(l,c-P/2,d,P,i),e.restore()}function k(){if(f=!1,u&&cancelAnimationFrame(u),a&&a.getTracks().forEach(p=>p.stop()),s&&s.close)try{s.close()}catch{}}return{setScale(p){y=p},capture(){return o.toDataURL("image/jpeg",.92)},stop:k}}var it=["XS","S","M","L","XL","XXL"],st=3e3,ct=20;function V({config:r,api:o,product:n,externalId:e}){let a=A(),s=n.name||a.name,u=n.garment_image_url||a.image,f=null,y=null,l=null,x="M",C=t("button",{class:"ff-fab",type:"button","aria-label":"FashionFit",onclick:_},r.buttonLabel);function E(){document.body.appendChild(C)}function _(){f&&f.remove(),y=t("div",{class:"ff-modal-body"}),f=t("div",{class:"ff-overlay",onclick:i=>{i.target===f&&k()}},t("div",{class:"ff-modal"},t("button",{class:"ff-close",type:"button","aria-label":"Zamknij",onclick:k},"\xD7"),y)),document.body.appendChild(f),requestAnimationFrame(()=>f.classList.add("ff-open")),w(),o.trackEvent("widget_open",{productId:n.id})}function k(){if(o.trackEvent("close",{productId:n.id}),p(),f){let i=f;i.classList.remove("ff-open"),setTimeout(()=>i.remove(),200),f=null}}function p(){l&&(l.stop(),l=null)}function b(...i){y.innerHTML="",i.forEach(c=>y.appendChild(c))}function I(){return t("div",{class:"ff-product"},u?t("img",{src:u,alt:s}):null,t("b",{},s))}function w(){p();let i=t("div",{class:"ff-sizes"},...it.map(c=>{let d=t("button",{class:`ff-size${c===x?" ff-active":""}`,type:"button",onclick:()=>{x=c,i.querySelectorAll(".ff-size").forEach(h=>h.classList.remove("ff-active")),d.classList.add("ff-active")}},c);return d}));b(t("h2",{class:"ff-h"},"Wirtualna przymierzalnia"),I(),t("div",{class:"ff-modes"},t("button",{class:"ff-mode",type:"button",onclick:z},t("span",{class:"ff-emoji"},"\u{1F4F8}"),t("span",{},"Wgraj zdj\u0119cie")),t("button",{class:"ff-mode",type:"button",onclick:U},t("span",{class:"ff-badge"},"Nowe"),t("span",{class:"ff-emoji"},"\u{1F4F9}"),t("span",{},"U\u017Cyj kamerki"))),t("div",{class:"ff-sub"},"Wybierz rozmiar"),i,t("div",{class:"ff-privacy"},"\u{1F512} Twoje zdj\u0119cia nie s\u0105 zapisywane"))}function z(){let i=null,c=t("input",{type:"file",accept:"image/jpeg,image/png",style:{display:"none"}}),d=t("div",{class:"ff-error",style:{display:"none"}}),h=t("button",{class:"ff-btn",type:"button",disabled:"true",onclick:()=>Z()},"Przymierz"),v=t("div",{}),g=t("div",{class:"ff-drop"},t("span",{class:"ff-emoji"},"\u2B06\uFE0F"),t("span",{},"Przeci\u0105gnij zdj\u0119cie lub kliknij, aby wgra\u0107"),t("span",{class:"ff-sub"},"JPG lub PNG, maks. 10MB"));function W(m){d.textContent=m,d.style.display=m?"block":"none"}async function R(m){let O=$(m);if(O){W(O);return}W(""),i=await B(m),v.innerHTML="",v.appendChild(t("img",{class:"ff-preview",src:i,alt:"Podgl\u0105d"})),h.removeAttribute("disabled")}g.addEventListener("click",()=>c.click()),g.addEventListener("dragover",m=>{m.preventDefault(),g.classList.add("ff-over")}),g.addEventListener("dragleave",()=>g.classList.remove("ff-over")),g.addEventListener("drop",m=>{m.preventDefault(),g.classList.remove("ff-over"),m.dataTransfer.files[0]&&R(m.dataTransfer.files[0])}),c.addEventListener("change",()=>{c.files[0]&&R(c.files[0])});async function Z(){if(i){o.trackEvent("tryon_start",{productId:n.id,metadata:{mode:"photo",size:x}}),j();try{let{sessionId:m}=await o.startPhotoTryon(n.id,i,{size:x});T(m)}catch(m){S(m.message)}}}b(t("h2",{class:"ff-h"},"\u{1F4F8} Wgraj swoje zdj\u0119cie"),g,c,v,d,t("div",{class:"ff-actions"},h,t("button",{class:"ff-btn ff-btn-ghost",type:"button",onclick:w},"\u2190 Wr\xF3\u0107")))}function j(){let i=t("span",{});b(t("div",{class:"ff-loading"},t("div",{class:"ff-spinner"}),t("b",{},"Generuj\u0119 dla Ciebie..."),t("div",{class:"ff-sub"},"To potrwa oko\u0142o 10 sekund"),t("div",{class:"ff-progress"},i)));let c=5,d=setInterval(()=>{c=Math.min(90,c+6),i.style.width=`${c}%`,f||clearInterval(d)},700);return()=>{clearInterval(d),i.style.width="100%"}}function T(i){let c=0,d=j(),h=setInterval(async()=>{if(c+=1,!f){clearInterval(h);return}try{let{status:v,resultImageUrl:g}=await o.getTryonStatus(i);v==="completed"&&g?(clearInterval(h),d(),L(g)):(v==="failed"||c>=ct)&&(clearInterval(h),S("Nie uda\u0142o si\u0119 wygenerowa\u0107 przymiarki. Spr\xF3buj ponownie."))}catch(v){clearInterval(h),S(v.message)}},st)}function S(i){b(t("h2",{class:"ff-h"},"Co\u015B posz\u0142o nie tak"),t("div",{class:"ff-error"},i),t("div",{class:"ff-actions"},t("button",{class:"ff-btn",type:"button",onclick:z},"Spr\xF3buj ponownie"),t("button",{class:"ff-btn ff-btn-ghost",type:"button",onclick:w},"\u2190 Wr\xF3\u0107")))}function L(i){o.trackEvent("tryon_complete",{productId:n.id,metadata:{size:x}}),b(t("h2",{class:"ff-h"},"Twoja przymiarka \u2728"),t("img",{class:"ff-result",src:i,alt:"Wynik przymiarki"}),t("div",{class:"ff-actions"},t("button",{class:"ff-btn",type:"button",onclick:F},"\u{1F6D2} Dodaj do koszyka"),t("button",{class:"ff-btn ff-btn-ghost",type:"button",onclick:()=>{o.trackEvent("download",{productId:n.id}),H(i,"fashionfit.jpg")}},"\u2B07\uFE0F Pobierz zdj\u0119cie"),t("button",{class:"ff-btn ff-btn-ghost",type:"button",onclick:w},"\u{1F501} Przymierz inne")))}async function U(){let i=t("video",{class:"ff-video",playsinline:"true",muted:"true"}),c=t("canvas",{class:"ff-canvas"}),d=t("input",{class:"ff-slider",type:"range",min:"0.6",max:"1.6",step:"0.05",value:"1"}),h=t("div",{class:"ff-sub"},"Uruchamiam kamer\u0119...");d.addEventListener("input",()=>{l&&l.setScale(parseFloat(d.value))}),b(t("h2",{class:"ff-h"},"\u{1F4F9} Przymierzalnia na \u017Cywo"),h,i,c,t("label",{class:"ff-sub"},"Dopasuj rozmiar"),d,t("div",{class:"ff-actions"},t("button",{class:"ff-btn",type:"button",onclick:v},"\u{1F4F8} Zr\xF3b zdj\u0119cie"),t("button",{class:"ff-btn ff-btn-ghost",type:"button",onclick:w},"\u2190 Wr\xF3\u0107"))),o.trackEvent("tryon_start",{productId:n.id,metadata:{mode:"ar",size:x}});try{l=await G({video:i,canvas:c,garmentUrl:n.garment_image_url}),h.textContent="Sta\u0144 w kadrze ca\u0142\u0105 sylwetk\u0105"}catch{P()}function v(){if(!l)return;let g=l.capture();p(),L(g)}}function P(){p(),b(t("h2",{class:"ff-h"},"Kamera niedost\u0119pna"),t("div",{class:"ff-sub"},"Nie uda\u0142o si\u0119 uzyska\u0107 dost\u0119pu do kamery. Skorzystaj z trybu zdj\u0119cia."),t("div",{class:"ff-actions"},t("button",{class:"ff-btn",type:"button",onclick:z},"\u{1F4F8} U\u017Cyj trybu zdj\u0119cia"),t("button",{class:"ff-btn ff-btn-ghost",type:"button",onclick:w},"\u2190 Wr\xF3\u0107")))}async function F(){if(o.trackEvent("add_to_cart",{productId:n.id,metadata:{size:x}}),!e){n.product_url&&(window.location=n.product_url);return}try{let i=new FormData;i.append("product_id",e),i.append("quantity","1"),await fetch(`${location.origin}/?wc-ajax=add_to_cart`,{method:"POST",body:i}),document.body.dispatchEvent(new Event("wc_fragment_refresh")),k()}catch{window.location=`${location.pathname}?add-to-cart=${e}`}}return{mount:E,open:_,close:k}}var ft=document.currentScript;async function J(){let r=N(ft);if(!r.apiKey||!r.shopId){console.warn("[FashionFit] Brak apiKey lub shopId \u2014 widget nie zosta\u0142 uruchomiony.");return}if(!D())return;let o=q();K(r.primaryColor);let n=X(r),e=null;if(o)try{let{products:a}=await n.getProducts(),s=a||[];if(e=s.find(u=>String(u.external_id)===String(o))||null,!e){let u=location.pathname.replace(/\/+$/,"");e=s.find(f=>{if(!f.product_url)return!1;try{return new URL(f.product_url).pathname.replace(/\/+$/,"")===u}catch{return!1}})||null}if(!e){let u=A(),f=y=>String(y||"").trim().toLowerCase();e=s.find(y=>f(y.name)===f(u.name))||null}}catch(a){console.warn("[FashionFit] Nie uda\u0142o si\u0119 pobra\u0107 produkt\xF3w:",a.message)}if(!e){console.warn("[FashionFit] Nie znaleziono zsynchronizowanego produktu dla id:",o);return}V({config:r,api:n,product:e,externalId:o}).mount()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",J):J();})();
